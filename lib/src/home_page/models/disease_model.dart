  ...
  Disease({required this.name, required this.imagePath}) {
    ...
    switch (name) {
      ...
      case "Tomato Septoria Leaf Spot":
        ...
        possibleSolution = "Remove infected leaves immediately, use organic fungicide options.";
        break;

      case "Tomato Spotted Spider Mites":
        possibleCauses = "Spider mite feeding on leaves during hot and dry conditions.";
        possibleSolution =
